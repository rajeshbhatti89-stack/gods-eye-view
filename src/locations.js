...
export const CITY_POIS = {
  delhi: {
    ...
    groundElevation: 210,
    viewBounds: {
      southwest: { lat: 28.4, lng: 76.84 },
      northeast: { lat: 28.88, lng: 77.35 },
    },
    pois: [
      {
        name: 'India Gate',
  ...
  mumbai: {
    ...
    groundElevation: 14,
    viewBounds: {
      southwest: { lat: 18.89, lng: 72.77 },
      northeast: { lat: 19.27, lng: 73.0 },
    },
    pois: [
      {
  ...
  bangalore: {
    ...
    groundElevation: 920,
    viewBounds: {
      southwest: { lat: 12.83, lng: 77.46 },
      northeast: { lat: 13.14, lng: 77.74 },
    },
    pois: [
      {
        name: 'Vidhana Soudha',
  ...
  chennai: {
    ...
    groundElevation: 6,
    viewBounds: {
      southwest: { lat: 12.94, lng: 80.12 },
      northeast: { lat: 13.18, lng: 80.32 },
    },
    pois: [
      {
        name: 'Marina Beach',
...
export async function searchAndFlyTo(viewer, query, options = {}) {
  ...
  if (
    ...
    // anyone means — "Kolkata" is the PREFECTURE, which owns islands ~1,000 km out,
 ...
 *
 * The 2026-08-20 QA hunt defect: "Kolkata" flew the camera ~977 km from Kolkata, out
 * over the open Pacific at 2,885 km altitude. Kolkata geocodes as
 * `administrative_area_level_1` (the prefecture), and Kolkata Metropolis owns the
 ...
 *
 *   gated    Kolkata      2,462 km box, anchor  977 km off  → ratio 0.397
 ...
 * matching the hand-tuned city pills (Kolkata's own pill is 42 x 34 km). Framing a
 ...
 * metro box around `geometry.location` (Kolkata proper) instead of the box centroid
